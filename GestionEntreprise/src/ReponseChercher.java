...
public class ReponseChercher {
	Object[] T;

	public JFrame frame;
		public ReponseChercher(Object[] T) throws SQLException {
			this.T=T;
			initialize();
		}
		...
		private void initialize() {
			...
			JLabel lblNewLabel = new JLabel("R\u00E9f\u00E9rence Client :");
			...
			JLabel lblNewLabel_2_1 = new JLabel("Sexe :");
			lblNewLabel_2_1.setFont(new Font("MV Boli", Font.BOLD, 30));
			lblNewLabel_2_1.setBounds(30, 255, 247, 35);
			panel.add(lblNewLabel_2_1);
			
			JLabel lblNewLabel_2_1_1 = new JLabel("Date naissance :");
			...
			JLabel lblNewLabel_3_3 = new JLabel (String.valueOf(T[3]));
			lblNewLabel_3_3.setFont(new Font("Tahoma", Font.PLAIN, 20));
			lblNewLabel_3_3.setBounds(501, 261, 275, 35);
			panel.add(lblNewLabel_3_3);
			
			JLabel lblNewLabel_3_4 = new JLabel (String.valueOf(T[4]));
			lblNewLabel_3_4.setFont(new Font("Tahoma", Font.PLAIN, 20));
			lblNewLabel_3_4.setBounds(501, 337, 265, 35);
			panel.add(lblNewLabel_3_4);
			
			JLabel lblNewLabel_4 = new JLabel("Les informations du client cherch\u00E9 :");
